...
\end{equation}
The factor 3 in denominator is connected with a trigger down-scaling. Due to limited read-out capabilities for hadronic channels each 3th triggered event was saved on tapes. A list of the reactions simulated for following analysis is prezented in \ref{tab:channels}. 
\begin{table}
    \centering
