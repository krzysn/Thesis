...
\begin{figure}[ht]
  ...
  \caption{A used neural network architecture.}
  \label{fig:NN}
\end{figure}


The final network archtecture used for $\Lz$ reconstruction is a feed-forward dense network with 4 layers, each N+6 neurons, where N is a number of scalar input parameters. Because the network took role after geometrical cuts, as an input eleven geometrical variables had been taken:
\begin{itemize}
